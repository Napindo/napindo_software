...
loadEnvFile(path.resolve(process.cwd(), "..", ".env"));
const API_BASE_URL = process.env.API_BASE_URL || process.env.VITE_API_BASE_URL || "http://localhost:8133";
const API_PREFIX = process.env.API_PREFIX || process.env.VITE_API_PREFIX || "/api";
